function data_out = Trinh_makecontinData(data_in, conditions,refrainonsets,triallength,prestim)
...
for i = 1:length(conditions)
    ...
    cfg.trl(:,3)             = -refrainonsets(1);% samples
    cfg.trl(:,4)             = conditions(i);
    data_refrain{i}          = ft_redefinetrial(cfg,data_seg);
end
    
data_out = ft_appenddata([],data_refrain{:});
end