...
% %         [data_baseline_bass]            = Trinh_MiniTrialMaker(data_int,{'Hopp_bass_onsets','Lola_bass_onsets'},[3,7],[0.5 1.5],3);
        [data_baseline]                 = Trinh_MiniTrialMaker(data_int,{'Hopp_bass_onsets','Lola_bass_onsets'},[3,7],[0.5 1.5],3.5);
% 
%         % Low Bass condition
% %         [data_lowbass_voice]            = Trinh_MiniTrialMaker(data_int,{'Hopp_voice_onsets','Lola_voice_onsets'},[4,8],[0.5 1.5],3);
% %         [data_lowbass_bass]             = Trinh_MiniTrialMaker(data_int,{'Hopp_bass_onsets','Lola_bass_onsets'},[4,8],[0.5 1.5],3);
        [data_lowbass]                  = Trinh_MiniTrialMaker(data_int,{'Hopp_bass_onsets','Lola_bass_onsets'},[4,8],[0.5 1.5],3.5);
% 
%         % High voice condition
% %         [data_highvoice_voice]          = Trinh_MiniTrialMaker(data_int,{'Hopp_voice_onsets','Lola_voice_onsets'},[5,9],[0.5 1.5],3);
% %         [data_highvoice_bass]           = Trinh_MiniTrialMaker(data_int,{'Hopp_bass_onsets','Lola_bass_onsets'},[5,9],[0.5 1.5],3);
        [data_highvoice]                = Trinh_MiniTrialMaker(data_int,{'Hopp_bass_onsets','Lola_bass_onsets'},[5,9],[0.5 1.5],3.5);
% 
%         % Control condition
% %         [data_control_voice]            = Trinh_MiniTrialMaker(data_int,{'Hopp_control_voice_onsets','Lola_control_voice_onsets'},[2,6],[0.5 1.5],3);
% %         [data_control_bass]             = Trinh_MiniTrialMaker(data_int,{'Hopp_control_bass_onsets','Hopp_control_bass_onsets'},[2,6],[0.5 1.5],3);
        [data_control]                  = Trinh_MiniTrialMaker(data_int,{'Hopp_control_bass_onsets','Hopp_control_bass_onsets'},[2,6],[0.5 1.5],3.5);
% 
%         % Silence condition
